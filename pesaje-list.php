	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-clipboard-list fa-fw"></i> &nbsp; PESO TOTAL
				</h3>
			...
			<div class="container-fluid">
				<form class="form-neon">
					<table>
						<tr>
						<th style="padding-right: 35px;">NO. CARGAMENTO</th>
						<th style="padding-right: 35px;">PARCIALIDADES</th>
						<th style="padding-right: 35px;">PESO TOTAL</th>
				...
				foreach ($pesajes as $pesaje) {	
					...
					echo '<td style="padding-right: 35px;">'.$pesaje->cant_parcialidades.'</td>';
					echo '<td style="padding-right: 35px;">'.$pesaje->peso_total.'</td>';
					echo '<td style="padding-right: 35px;">'.$pesaje->tolerancia.'</td>';
					echo '</tr>';
				}
				?>
					</table>
